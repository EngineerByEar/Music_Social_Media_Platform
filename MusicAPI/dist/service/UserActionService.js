...
export class UserActionService {
    static async check_if_following(requesting_user_id, profile_id) {
    ...
    static async unfollow_user(data) {
        const user_id_following = await UserService.getUserId(data.user_following);
        const user_id_followed = await UserService.getUserId(data.user_followed);
        if (!user_id_followed) {
            return "USER_DOES_NOT_EXIST";
...
//# sourceMappingURL=UserActionService.js.map