...
export class UserController {
    ...
    static async init_profile(username) {
        ...
        await UserService.init_profile(default_profile_image_url, default_preview_image_url, default_profile_description, user_id);
    }
}
