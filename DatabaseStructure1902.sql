...
CREATE TABLE `genres` (
  `genre` varchar(255) UNIQUE PRIMARY KEY NOT NULL,
  `genre_id` int(4) UNIQUE NOT NULL AUTO_INCREMENT
);
...
ALTER TABLE `genres` ADD FOREIGN KEY (`genre`) REFERENCES `postaudiogenres` (`audio_genre`);
